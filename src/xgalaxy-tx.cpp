...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("XGalaxy Core xgalaxy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xgalaxy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xgalaxy transaction") + "\n" +
              "  xgalaxy-tx [options] -create [commands]   " + _("Create hex-encoded xgalaxy transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xgalaxy transaction
