 ...
 *
 *   // network
 *   CTankNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.tankcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTankNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TankNetwork
// //   -- signature requirements : Key1(User)
// class CTankNetworkVariable : public CGovernanceObject
// {
// private:
