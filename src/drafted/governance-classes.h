 ...
 *
 *   // network
 *   CXGalaxyNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.xgalaxycoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CXGalaxyNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CXGalaxyNetwork(UniValue objIn)
    {
...
// // can be under: XGalaxyNetwork
// //   -- signature requirements : Key1(User)
// class CXGalaxyNetworkVariable : public CGovernanceObject
// {
// private:
