...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "XGalaxyNetwork") type = XGalaxyNetwork;
    if(strType == "XGalaxyNetworkVariable") type = XGalaxyNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == XGalaxyNetwork) s = "XGalaxyNetwork";
    if(type == XGalaxyNetworkVariable) s = "XGalaxyNetworkVariable";
