...
static const CAmount MN_COLLATERAL                      = 300000;
//
...
//
// The Masternode Class. For managing the Darksend process. It contains the input of the 300000 XGALAXY, signature to prove
