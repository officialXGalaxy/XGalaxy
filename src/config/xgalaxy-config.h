/* src/config/xgalaxy-config.h.  Generated from xgalaxy-config.h.in by configure.  */
/* src/config/xgalaxy-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef XGALAXY_CONFIG_H

#define XGALAXY_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The XGalaxy Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "XGalaxy Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/XGalaxy/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "XGalaxy Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XGalaxy Core 0.9.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xgalaxycore"
