    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("XGalaxy Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About XGalaxy Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  xgalaxy-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the XGalaxy in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an xgalaxytive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 XGALAXY, 0.1 XGALAXY, 1 XGALAXY and 10 XGALAXY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://xgalaxycoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://xgalaxycoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("XGalaxy Core is shutting down...") + "<br /><br />" +
