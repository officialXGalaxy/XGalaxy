    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Tank Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Tank Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tank-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Tank in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an tanktive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 TANK, 0.1 TANK, 1 TANK and 10 TANK -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tankcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://tankcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Tank Core is shutting down...") + "<br /><br />" +
