    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Tank Core");
    ...
    QString copyrightTextTank   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Tank Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextTank);
