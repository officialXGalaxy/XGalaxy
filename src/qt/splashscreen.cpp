    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("XGalaxy Core");
    ...
    QString copyrightTextXGalaxy   = QChar(0xA9)+QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The XGalaxy Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextXGalaxy);
