    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("XGalaxy Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XGalaxy address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xgalaxy: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About XGalaxy Core"), this);
    aboutAction->setStatusTip(tr("Show information about XGalaxy Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XGalaxy Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XGalaxy addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XGalaxy addresses"));
    ...
    openAction->setStatusTip(tr("Open a xgalaxy: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XGalaxy Core help message to get a list with possible XGalaxy Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("XGalaxy Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XGalaxy network", "", count));
}
...
{
    QString strTitle = tr("XGalaxy Core"); // default title
