    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Tank Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tank address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tank: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Tank Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tank Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tank Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tank addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tank addresses"));
    ...
    openAction->setStatusTip(tr("Open a tank: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tank Core help message to get a list with possible Tank Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Tank Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tank network", "", count));
}
...
{
    QString strTitle = tr("Tank Core"); // default title
