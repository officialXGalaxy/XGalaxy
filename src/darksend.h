...
{
public:
    /// Is the input associated with this public key? (and there is 300000 XGALAXY - checking if valid masternode)
...
private:
    ...
    /// Get the denominations for a specific amount of xgalaxy.
