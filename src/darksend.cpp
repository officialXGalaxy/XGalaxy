...
{
    if(fLiteMode) return; // ignore all XGalaxy related functionality
...
/*
    ...
    allow endless transaction that would bloat XGalaxy and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("xgalaxy-privatesend");
