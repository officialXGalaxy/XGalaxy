...
2. run xgalaxyd with -printalert or -sendalert like this:
   /path/to/xgalaxyd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://xgalaxycoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/XGalaxy Core:0.12.0.58/"));
