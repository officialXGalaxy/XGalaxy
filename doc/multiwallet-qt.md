...
Only requiring some minor changes is xgalaxy.cpp.
...
Changes to xgalaxy.cpp
----------------------
xgalaxy.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
