...
Only requiring some minor changes is tank.cpp.
...
Changes to tank.cpp
----------------------
tank.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
