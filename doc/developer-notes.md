...
XGalaxy Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as XGalaxy Core, where everyone uses
...
pay attention to for reviewers of XGalaxy Core code.

General XGalaxy Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: XGalaxy Core uses tinyformat, which is type safe. Leave them out to avoid confusion
