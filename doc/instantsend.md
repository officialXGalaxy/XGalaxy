...
This mechanism has been integrated into Bitcore-Node-XGalaxy which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xgalaxycoin/insight-api-xgalaxy#web-socket-api](https://github.com/xgalaxycoin/insight-api-xgalaxy#web-socket-api) 
* API: [https://github.com/xgalaxycoin/insight-api-xgalaxy#instantsend-transactions](https://github.com/xgalaxycoin/insight-api-xgalaxy#instantsend-transactions) 
...
By default, the XGalaxy Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XGalaxy Core daemon:
