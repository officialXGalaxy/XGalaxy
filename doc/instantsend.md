...
This mechanism has been integrated into Bitcore-Node-Tank which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tankcoin/insight-api-tank#web-socket-api](https://github.com/tankcoin/insight-api-tank#web-socket-api) 
* API: [https://github.com/tankcoin/insight-api-tank#instantsend-transactions](https://github.com/tankcoin/insight-api-tank#instantsend-transactions) 
...
By default, the Tank Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Tank Core daemon:
